...
<div>
  ...
  {{-- Breadcrumb --}}
  <div class="mb-5">
    <nav class="flex overflow-x-auto no-scroll-bar" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse whitespace-nowrap">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('admin.anggota.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Anggota</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('admin.anggota.create') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Tambah Anggota</a>
          </div>
        </li>
      </ol>
    </nav>
