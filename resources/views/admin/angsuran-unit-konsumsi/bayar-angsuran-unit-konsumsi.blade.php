...
@section('content')
  <div>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('admin.angsuran-unit-konsumsi.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Angsuran</a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('admin.angsuran-unit-konsumsi.edit', $angsuran->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Bayar Angsuran Unit Konsumsi</a>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <form action="{{ route('admin.angsuran-unit-konsumsi.update', $angsuran->id) }}" method="POST">
      @csrf
      @method('PUT')
      <div class="mb-3">
        <label class="block mb-1 text-sm font-medium text-gray-900">Nama Anggota</label>
        <input type="text" name="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500   focus:border-green-500 block w-full p-2" value="{{ old('nama', $angsuran->unit_konsumsi->pengajuan_unit_konsumsi->anggota->nama) }}" readonly/>
