...
@section('content')
  ...
  <div>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse whitespace-nowrap">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('admin.angsuran.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Angsuran Pinjaman</a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('admin.angsuran.edit', $angsuran->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Bayar Angsuran Pinjaman</a>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-xl font-bold">Bayar Angsuran Pinjaman</h1>
    </div>
    ...
    @livewire('form-bayar-angsuran', ['id' => $angsuran->id])
