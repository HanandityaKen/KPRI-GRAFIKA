...
<div>
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('admin.jkk') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">JKK</a>
          </div>
        </li>
      </ol>
    </nav>
  ...
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-xl font-bold">Jurnal Kas Keluar</h1>
  </div>
    ...
    {{-- <table id="default-table">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>{{$jkk->nama}}</td>
            <td>{{ \Carbon\Carbon::parse($jkk->tanggal)->translatedFormat('j F Y') }}</td>
            ...
            <td>- Rp {{ number_format($jkk->total_b_lain, 0, ',', '.') }}</td>
