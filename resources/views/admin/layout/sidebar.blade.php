  ...
  <ul class="space-y-1 font-medium">
      ...
      <li>
        ...
        <ul id="dropdown-piutang" class="hidden space-y-0">
            <li>
                <a href="{{ route('admin.pengajuan-pinjaman.index') }}" class="flex item-center w-full p-1 text-green-800 transition duration-75 rounded-lg pl-11 group hover:bg-green-700 hover:text-white text-sm">Pinjaman</a>
            </li>
            <li>
      ...
      {{-- <li>
        <a href="{{ route('admin.persentase.index') }}"
            ...
            <span class="font-semibold group-hover:text-white">Persentase</span>
        </a>
      </li> --}}
      <li>
        <button type="button"
        ...
        <ul id="dropdown-master-settings" class="hidden space-y-0">
            ...
            <li>
                <a href="" class="flex item-center w-full p-1 text-green-800 transition duration-75 rounded-lg pl-11 group hover:bg-green-700 hover:text-white text-sm">Pokok</a>
            </li>
        </ul>
      </li>
    </li>
