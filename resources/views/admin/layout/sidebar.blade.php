<div class="w-64 bg-[#DCFED0] h-screen p-4 fixed-sidebar">
  ...
  <!-- Navigation Links -->
  <nav class="space-y-2">
    <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/dashboard') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="{{ route('admin.anggota' )}}" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/anggota') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="simpanan.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/simpanan') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="keuangan.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/keuangan') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="pembagian-shu.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/pembagian-shu') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="sisa-hutang-anggota.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/sisa-hutang-anggota') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="pengurus.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/pengurus') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="angsuran.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/angsuran') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="pinjaman.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/pinjaman') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="presentase.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/persentase') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="manasuka.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/manasuka') ? 'opacity-100' : 'opacity-60' }}">
    ...
    <a href="unit-konsumsi.html" class="flex items-center p-2 hover:bg-green-700 rounded cursor-pointer group {{ Request::is('admin/unit-konsumsi') ? 'opacity-100' : 'opacity-60' }}">
