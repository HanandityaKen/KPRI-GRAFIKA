      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('admin.pengurus.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Anggota</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('admin.pengurus.edit', $user->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Edit Pengurus</a>
          </div>
        </li>
      </ol>
    </nav>
