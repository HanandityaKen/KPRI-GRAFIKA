...
@section('content')
  <div>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('admin.wajib-pinjam.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Pokok</a>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-xl font-bold">Pokok</h1>
    </div>
