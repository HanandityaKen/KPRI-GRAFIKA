          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('admin.unit-konsumsi.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Unit Konsumsi</a>
              </div>
            </li>
          </ol>
        </nav>
