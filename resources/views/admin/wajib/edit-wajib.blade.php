...
@section('content')
    <div>
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('admin.wajib.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Simpanan Wajib</a>
              </div>
            </li>
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('admin.wajib.edit', $wajib->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Edit Simpanan Wajib</a>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-bold">Edit Simpanan Wajib</h1>
      </div>

      <form action="{{ route('admin.wajib.update', $wajib->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
          <label class="block mb-1 text-sm font-medium text-gray-900">Jenis Pegawai</label>
          <input type="text" name="jenis_pegawai" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" value="{{ old('jenis_pegawai', $wajib->jenis_pegawai) }}" placeholder="Masukan Jenis Pegawai" readonly/>
        </div>
        <div class="mb-6">
