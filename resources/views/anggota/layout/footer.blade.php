...
<footer class="bg-white text-gray-800 py-10">
  ...
  <div class="container mx-auto px-6 md:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
      ...
      <div class="flex flex-col space-y-4">
        ...
        <div class="space-y-3 px-5">
          ...
          <p class="flex items-center gap-5 text-sm">
            ...
            <a href="tel:0341353735" class="hover:text-green-600">0341-353735</a>
          </p>
        </div>
      </div>
      ...
      <div class="flex flex-col px-4 md:px-0 space-y-4">
        ...
        <div class="flex space-x-4">
          ...
          <a href="https://www.instagram.com/official.smkn4malang/" target="_blank" class="p-2 bg-gray-100 rounded-full hover:bg-green-100 transition">
            <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://wa.me/6281232075930?text=Halo%20KPRI%20Grafika" target="_blank" class="p-2 bg-gray-100 rounded-full hover:bg-green-100 transition">
            <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://youtube.com/@smkn4malangofficial?si=Kc05p1u1J3z0_ihm" target="_blank" class="p-2 bg-gray-100 rounded-full hover:bg-green-100 transition">
            <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="flex flex-col px-4 md:px-0 space-y-4">
        ...
        <div class="aspect-w-16 aspect-h-9">
          <iframe 
            ...
            class="w-full h-48 rounded-lg shadow-md border-0" 
            allowfullscreen 
            loading="lazy"
          ></iframe>
        </div>
        <a 
          href="https://maps.app.goo.gl/oc2pLqTWyLBdQJzY8" 
          target="_blank" 
    ...
    <div class="text-center text-sm text-gray-500">
      <p>© {{ date('Y') }} KPRI Grafika. All rights reserved.</p>
    </div>
  </div>
</footer>