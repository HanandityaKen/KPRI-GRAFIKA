    ...
    <div class="max-w-full mx-auto px-20">
        <h1 class="text-xl font-bold mb-4">Personal Data</h1>
            <div class="mb-3">
                ...
                <input wire:model.live="nama" type="text" name="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" value="{{ old('nama') }}"/>
