<div>
    ...
    <form action="{{ route('admin.neraca.store-perhitungan-neraca') }}" method="POST">
        @csrf
        <div class="mb-4">
            <label class="block mb-1 text-sm font-medium text-gray-900">
                Tahun <span class="text-red-500">*</span>
            </label>
            <input type="number" wire:model.live="tahun" id="tahun" name="tahun" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" placeholder="Tahun" inputmode="numeric" min="2024" value="{{ old('tahun', \Carbon\Carbon::now()->format('Y')) }}" required/>
