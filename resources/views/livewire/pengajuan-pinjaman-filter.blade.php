                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="p-3 text-center whitespace-nowrap border-l border-[#6DA854]">
                            @if ($pengajuanPinjaman->status == 'menunggu')
                                ...
                                {{-- setujui modal --}}
                                <div id="setujui-modal-{{ $pengajuanPinjaman->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full min-h-screen bg-gray-900 bg-opacity-40">
                                            ...
                                            <form id="form-setujui" action="{{ route('admin.setujui-pengajuan-pinjaman', $pengajuanPinjaman->id) }}" method="POST" class="inline">
                                                ...
                                                <div class="p-6 space-y-4">
                                                    ...
                                                    <div class="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100 text-sm text-blue-800">
                                                        ...
                                                        <p class="text-sm text-left whitespace-normal leading-relaxed">Pastikan data pinjaman sudah benar sebelum menyetujui</p>
                                                    </div>
                                ...
                                {{-- tolak modal --}}
                                <div id="tolak-modal-{{ $pengajuanPinjaman->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full min-h-screen bg-gray-900 bg-opacity-40">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow-xl">
                                            <!-- Modal header -->
                                            ...
                                            <form id="form-tolak" action="{{ route('admin.tolak-pengajuan-pinjaman', $pengajuanPinjaman->id) }}" method="POST" class="inline">
                                                ...
                                                <div class="p-6 space-y-4">
                                                    ...
                                                    <div class="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100 text-sm text-blue-800">
                                                        ...
                                                        <p class="text-sm text-left whitespace-normal leading-relaxed">Pastikan data pinjaman sudah benar</p>
                                                    </div>
