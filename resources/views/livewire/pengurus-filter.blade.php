        ...
        <table class="w-full mb-8">
            <thead>
                <tr>
                    ...
                    <th class="p-3 text-center whitespace-nowrap border-l border-r border-b border-[#6DA854]">Posisi</th>
                    <th class="p-3 text-center whitespace-nowrap border-l border-r border-b border-[#6DA854]">Jabatan</th>
            ...
            <tbody>
                @forelse ($users as $index => $user)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="p-3 text-center text-[#6DA854] border-r border-[#6DA854]">{{ $index + 1 }}</td>
                        <td class="p-3 text-center border-l border-r border-[#6DA854]">{{ $user->no_anggota }}</td>
