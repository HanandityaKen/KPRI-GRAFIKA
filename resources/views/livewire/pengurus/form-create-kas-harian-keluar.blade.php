    ...
    <form action="{{ route('pengurus.kas-harian.store') }}" id="formCreateJkk" method="POST">
        ...
        <div class="mb-4">
            ...
            <div class="relative w-full">
                ...
                <input id="datepicker-kas-keluar" name="tanggal" type="text" class="tanggal bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full ps-10 p-2.5" value="{{ old('tanggal', \Carbon\Carbon::now()->format('d-m-Y')) }}" placeholder="Pilih Tanggal" required>
            </div>
        </div>
        <div class="mb-4">
        ...
        <div class="{{ $bendahara ? '' : 'hidden' }}">
            <div class="mb-4">
                ...
                <input wire:model.live="lain_lain" type="text" id="lain-lain" name="lain_lain" class="format-rupiah bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" placeholder="Masukan Nominal Beban Lain" inputmode="numeric" value="{{ old('lain_lain') }}" />
            </div>
            {{-- Accordion --}}
