            ...
            <div class="mb-4">
                <div id="accordion-collapse" data-accordion="open">
                    ...
                    <div class="rounded-lg">
                        ...
                        <div id="accordion-collapse-body-2" class="{{ ($hari_lembur || $perjalanan_pengawas || $thr || $admin || $iuran_dekopinda) ? '' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-2">
                    ...
                    <div class="rounded-lg">
                        ...
                        <div id="accordion-collapse-body-3" class="{{ ($rkrab || $pembinaan || $harkop || $dandik) ? '' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-3">
                            <div class="p-5 border border-t-0 border-gray-200 bg-white">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                    ...
                    <div class="rounded-lg">
                        ...
                        <div id="accordion-collapse-body-4" class="{{ ($rapat || $jasa_manasuka) ? '' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-4">
                            <div class="p-5 border border-t-0 border-gray-200 bg-white">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                    ...
                    <div class="rounded-lg">
                        ...
                        <div id="accordion-collapse-body-1" class="{{ ($pajak || $tabungan_qurban || $dekopinda || $wajib_pkpri || $dansos || $shu || $dana_pengurus) ? '' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-1">
                            <div class="p-5 border border-t-0 border-gray-200 bg-white">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
