    ...
    <form action="{{ route('pengurus.pengajuan-pinjaman.update', $pinjaman->id) }}" method="POST">   
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="mb-3">
                ...
                <div wire:ignore>
                    <select wire:model.lazy="anggota_id" id="select_nama_kas_masuk" name="anggota_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                        ...
                        @if(!array_key_exists($pinjaman->anggota_id, $namaList))
                            <option disabled value="{{ $pinjaman->anggota_id }}" selected>{{ $pinjaman->nama_anggota }}</option>
                        @endif
            ...
            <div class="mb-3">
                ...
                <input type="text" wire:model="nominal_bunga" id="nominal_bunga" name="nominal_bunga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" placeholder="Nominal Jasa" inputmode="numeric" readonly/>
            </div>
            <div class="mb-3">
