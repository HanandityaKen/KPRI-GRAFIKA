<div>
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('admin.wajib.create') }}" wire:ignore class="bg-green-800 text-white py-2 px-4 rounded-md flex items-center ml-4 whitespace-nowrap">
                ...
                @forelse ($wajibs as $index => $wajib)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="text-center whitespace-nowrap">
                            ...
                            onclick="confirmDelete({{ $wajib->id }})">
                                Hapus
                        </button>
                        <form id="delete-form-{{ $wajib->id }}" action="{{ route('admin.wajib.destroy', $wajib->id) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                        </td>
