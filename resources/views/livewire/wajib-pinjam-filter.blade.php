            ...
            <tbody>
                @forelse ($wajib_pinjams as $index => $wajib_pinjam)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="p-3 text-center text-[#6DA854] border-r border-[#6DA854]">{{ $wajib_pinjams->firstItem() + $index }}</td>
                        <td class="p-3 text-right whitespace-nowrap border-l border-r border-[#6DA854]">Rp {{ number_format($wajib_pinjam->nominal, 0, ',', '.') }}</td>
