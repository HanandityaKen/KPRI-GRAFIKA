...
@section('title', 'Angsuran Unit Konsumsi')
  ...
  <div>
    <hr class="my-5 border-t-[2px] border-green-800 opacity-20 mb-5" />
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('pengurus.angsuran-unit-konsumsi.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Angsuran Unit Konsumsi</a>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-bold">Angsuran Unit Konsumsi</h1>
      </div>
      ...
      @livewire('pengurus.angsuran-unit-konsumsi-filter')
