  ...
  <div>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Bayar Angsuran</a>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <form action="{{ route('pengurus.angsuran.update', $angsuran->id) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500   focus:border-green-500 block w-full p-2" value="{{ old('nama', $angsuran->pinjaman->pengajuan_pinjaman->anggota->nama) }}" readonly/>
