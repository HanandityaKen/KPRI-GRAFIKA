          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('pengurus.pengajuan-pinjaman.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Riwayat Transaksi</a>
              </div>
            </li>
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('pengurus.detail-pengajuan-pinjaman', $pengajuanPinjaman->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Detail Riwayat Transaksi</a>
              </div>
            </li>
          </ol>
        </nav>
